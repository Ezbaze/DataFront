# 🧩 DataFront - Sidebar for OpenFront
...
- **Customizable Map Overlays**: Tailor the map overlays to match your strategy by defining how terrain, paths, and tactical highlights appear. You’ll be able to colour regions, emphasize player territory, and layer bespoke visual cues so the battlefield reflects exactly what matters most to you.
